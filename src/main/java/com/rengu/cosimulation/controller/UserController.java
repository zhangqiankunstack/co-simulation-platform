...
public class UserController {
    ...
    public Result importUser(@RequestParam(name = "type") String type, @RequestBody MultipartFile file) throws Exception {
        return ResultUtils.success(userService.importUser(type, file));
    }
